<template>
  <div id="main" >
    <div id="search">
      ...
      <div style="padding-left:0.2rem;display:flex;flex-direction:row;" class="pop" v-if="showModal" @dblclick="showModal=false" >
          <div style="margin-right:1rem;display:flex; flex-direction: column;">
              <p   name="detail"  style="font-size:1.3rem;margin-left: 2rem;text-align: left;height:2rem;margin-top:0.3rem;margin-bottom:0.3rem" >{{detail.word}}</p>
...
export default {
  name: 'dictionary',
  components:{player,player2,frequency,pronunciation_sentence1,pronunciation_sentence2,pic},
   data() {
        return{
          data: "",
          detail:"",
